...
class GraphProcessor():
    ...
    def run(self):
        ...
        os.environ['GPT_BIN'] = '/opt/anaconda/envs/env_ewf_satcen_03_01_01/snap/bin/gpt'
        logging.info('Processing the graph')
        
        fd, path = tempfile.mkstemp()
        ##PP added
        ciop.log('DEBUG', 'processing path generated: {}'.format(path)) ##PP added
        rc = None
        ...
        try:
            ...
            options = [#self.gpt_path,
               ...
               '2048M',
               path]
            ciop.log('DEBUG', 'list of options sent to run_command : {}'.format(options)) ##PP added
